...
const onsjsPackage = require('@app/../node_modules/@opdomains/onsjs/package.json')
...
describe('ProfileEditor', () => {
  ...
  it('should have use the same version of address-encoder as onsjs', () => {
    expect(appPackage.dependencies['address-encoder']).toEqual(
      onsjsPackage.dependencies['address-encoder'],
    )
  })

  it('should render', async () => {
    render(
      <ProfileEditor data={{ name: 'test.op' }} dispatch={mockDispatch} onDismiss={() => {}} />,
    )
    await waitFor(() => {
