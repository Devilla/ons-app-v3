...
import { ThorinGlobalStyles, lightTheme as thorinLightTheme } from '@opdomains/thorin'
...
import { OnsProvider } from '@app/utils/OnsProvider'
  ...
  [
    ...(process.env.NEXT_PUBLIC_PROVIDER
      ...
      : [
          // jsonRpcProvider({
          //   rpc: (c) => ({
          //     http: `https://goerli.infura.io/v3/${ // todo https://optimism-goerli.infura.io/v3/0722a322db3e472881be79bebc2e994c
          //       c.network === 'homestead' ? 'goerli' : c.network
          //     }`,
          //   }),
          // }),
          // infuraProvider({ apiKey: '74143fbe4768444c98f54b89f7ecb777' }),
        ]),
  ],
)
