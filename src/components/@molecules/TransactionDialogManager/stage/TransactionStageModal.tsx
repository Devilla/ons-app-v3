...
import { Button, Dialog, Helper, Spinner, Typography } from '@opdomains/thorin'
...
export const TransactionStageModal = ({
  ...
  const {
    ...
    {
      enabled: !!transaction && !!signer && !!ons && !(stage === 'sent' || stage === 'complete'),
    },
  )
  const requestError = _requestError as TxError | null
  useInvalidateOnBlock({
    enabled: !!transaction && !!signer && !!ons,
