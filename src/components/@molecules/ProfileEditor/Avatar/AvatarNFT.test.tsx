...
import * as ThorinComponents from '@opdomains/thorin'
...
describe('<AvatarNFT />', () => {
  ...
  it('should not display ONS NFTs', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      json: () => ({
        ownedNfts: Array.from(
          { length: 5 },
          generateNFT(true, '0xec4Db896Eed2bA0F16c659d174588ff39DC09A9c'),
        ),
        totalCount: 5,
      }),
    })
    ...
    await waitFor(() =>
      expect(
        screen.queryByTestId('nft-0-0xec4Db896Eed2bA0F16c659d174588ff39DC09A9c'),
