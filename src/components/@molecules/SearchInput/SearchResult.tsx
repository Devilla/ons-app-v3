...
import { Avatar, Spinner, Tag, Typography } from '@opdomains/thorin'
...
type SearchItemType = 'text' | 'error' | 'address' | 'name' | 'nameWithDotOp'
...
export const SearchResult = ({
  ...
  const clickable = useMemo(() => {
    if (type === 'name' || type === 'nameWithDotOp') {
