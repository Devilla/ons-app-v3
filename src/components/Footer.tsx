...
import { mq } from '@opdomains/thorin'
  ...
  return (
    <Container>
      ...
      <TrailingStack>
        ...
        <SocialIconContainer>
          <SocialIcon Icon={SocialTwitter} color="#5298FF" href="https://twitter.com/opnamesorg" />
          <SocialIcon Icon={SocialGithub} color="#0F0F0F" href="https://github.com/op-domains" />
          <SocialIcon Icon={SocialDiscord} color="#7F83FF" href="https://discord.gg/RTayddEKrD" />
          {/* <SocialIcon
            Icon={SocialMedium}
            color="#0F0F0F"
